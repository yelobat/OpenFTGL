...
ll_matrix_orthographic(float top, float right,
                       float bottom, float left, float near, float far)
{
        ll_mat4_orthographic(ll_matrices+ll_matrices_idx, top, right, bottom,
                             left, near, far);
}
...
ll_matrix_perspective(float fovy, float aspect,
                      float near, float far)
{
        ll_mat4_perspective(ll_matrices+ll_matrices_idx, fovy, aspect,
                            near, far);
}
...
{
        ll_mat4_frustum(ll_matrices+ll_matrices_idx, left, right, bottom, top,
                        near, far);
}
